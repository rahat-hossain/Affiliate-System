            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">{{ __('Reffer By') }}</label>
                            <div class="col-md-6">
                                <input type="text" readonly disabled class="form-control" value="{{ Session::get('phone') }}">
                            </div>
                        </div>
