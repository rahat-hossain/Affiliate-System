                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        @auth
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('admin/discountrule') }}">Discount rules</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('admin/packages') }}">Packages</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('admin/marketing') }}">Marketings</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('admin/setting') }}">Settings</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('admin/coupon') }}">Coupon</a>
                            </li>
                            <li class="nav-item">
